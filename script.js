...
const content = {
    en: {
        ...
        aboutPara1: "Hello! I'm <span class=\"font-semibold text-blue-600\">Dip Aryal</span>, a Software Developer with 5+ years of experience in Software Development. Throughout my career, I've consistently thrived in fast-paced startup environments, delivering exceptional results by taking end-to-end responsibility for projects, from ideation and design to development and deployment.",
        aboutPara2: "My work on multiple full-stack applications showcases my ability to collaborate closely, communicate clearly, and maintain a solutions-focused mindset to meet both technical and user-centric goals, all while producing maintainable, quality code a value I know we share.",
        aboutPara3: "Outside of work, you can find me exploring new places through travel, diving deep into personal coding projects, and reading up on the latest tech trends. I'm always eager to connect with fellow professionals and explore new opportunities. Let's build something amazing together!",
    ...
    de: {
        ...
        aboutPara1: "Hallo! Ich bin <span class=\"font-semibold text-blue-600\">Dip Aryal</span>, ein Softwareentwickler mit 5+ Jahren Erfahrung. In meiner Karriere habe ich oft in schnelllebigen Startups gearbeitet und dabei sehr gute Ergebnisse erzielt. Ich übernehme gerne die volle Verantwortung für Projekte von der Idee über das Design bis hin zur Entwicklung und Veröffentlichung.",
        aboutPara2: "Meine Arbeit an mehreren Full-Stack-Anwendungen zeigt, dass ich gut im Team arbeite, klar kommuniziere und immer nach Lösungen suche – sowohl für technische als auch für nutzerfreundliche Ziele. Dabei achte ich darauf, sauberen und gut wartbaren Code zu schreiben – ein Wert, den wir beide teilen.",
        aboutPara3: "In meiner Freizeit reise ich gerne, arbeite an eigenen Programmierprojekten und lese über neue Technologietrends. Ich freue mich immer, andere Fachleute kennenzulernen und neue Möglichkeiten zu entdecken. Lass uns gemeinsam etwas Großartiges schaffen!",
